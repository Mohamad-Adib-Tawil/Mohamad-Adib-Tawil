...
<!-- Replace with your own widget if available; kept hidden by default -->
<!-- [![Spotify](https://spotify-readme.sp-xd.vercel.app/api/spotify)](https://open.spotify.com/) -->
...
![Dio](https://img.shields.io/badge/Dio-0A66C2?style=flat&logo=flutter&logoColor=white)
![Google Cloud](https://img.shields.io/badge/Google_Cloud-4285F4?style=flat&logo=google-cloud&logoColor=white)
![GitHub Actions](https://img.shields.io/badge/GitHub_Actions-2088FF?style=flat&logo=github-actions&logoColor=white)
...
class About extends Me {
  const myTools = {
    "ProgrammingLanguages": {"Dart"},
    "StateManagement": {"BLoC", "Cubit"},
    "Architecture": {"Clean Architecture", "Repository", "DI (GetIt)"},
    "Networking": {"Dio", "REST", "WebSocket"},
    "Backend": {"Supabase", "Firebase", "Appwrite"},
    "Storage": {"Hive", "SQLite"},
    "AI_OCR": {"ML Kit", "Tesseract"},
...
- <img alt="GIF" src="https://github.com/SP-XD/SP-XD/blob/main/images/Developer.gif?raw=true" width="25" /> &nbsp; Currently focusing on performance optimization, CI/CD and scalable real-time features.
- <img src="https://github.com/SP-XD/SP-XD/blob/main/images/hyperkitty.gif?raw=true" width="20" />&nbsp;&nbsp;&nbsp; I enjoy building multilingual, responsive UIs with Flutter.
- <img src="https://github.com/SP-XD/SP-XD/blob/main/images/message.gif?raw=true" width="25" />&nbsp;&nbsp; Ask me about Flutter, BLoC, Supabase, App architecture.
- <img src="https://github.com/SP-XD/SP-XD/blob/main/images/letterbox.gif?raw=true" width="25" /> &nbsp; Connect on LinkedIn: **[Mohamad Adib Tawil](https://www.linkedin.com/in/mohamad-adib-tawil-54024b314/)**
